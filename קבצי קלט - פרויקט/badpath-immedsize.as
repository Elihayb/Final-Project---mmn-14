...
; 2. this line is ok (largest positive immediate that fits in 12 bits)
       cmp #2047,DATA1

; 3. invalid first operand (positive immediate too large to fit in 12 bits)
       cmp #2048,DATA1

; 4. this line is ok (lowest negative immediate that fits in 12 bits)
       cmp r2,#-2048

; 5. invalid second operand (negative immediate too large to fit in 12 bits)
       cmp r2,#-2049
